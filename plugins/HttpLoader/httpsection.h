...
public:
    ...
    enum Errors{
        ...
        RANGES_NOT_ACCEPTED = -7 //сервер ответил, что докачка возможна, но всегда отвечает 200 ОК
    };
...
signals:
    ...
    void rangeAccepted(); //сигнал генерится, когда был принят ответ сервера 206
